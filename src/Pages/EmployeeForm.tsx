	...
	<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-violet-100">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				<div className="col-span-full sm:col-span-3">
					...
					<input id="dob" type="date" placeholder="dob" value={values.dob} name="dob" onChange={handleInputChange}
					className=" w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 text-gray-90" />
				</div>
				<div className="col-span-full sm:col-span-3">
					<label htmlFor="gender" className="text-sm">Gender</label>
					<input id="gender" type="text" placeholder="Gender" value={values.gender} name='gender' onChange={handleInputChange}
				...
				<div className="col-span-full sm:col-span-3">
					...
					<input id="mobileNumber" type="mobileNumber" placeholder="mobileNumber"  value={values.mobileNumber} name='mobileNumber' onChange={handleInputChange}
					 className="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900" />
				</div>
				<div className="col-span-full">
					<label htmlFor="address" className="text-sm">Address</label>
					<input id="address" type="text" placeholder=""  value={values.address} name='address' onChange={handleInputChange}
					className="w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 dark:text-gray-900" />
				</div>
				<div className="col-span-full sm:col-span-2">
					<label htmlFor="city" className="text-sm">City</label>
					<input id="city" type="text" placeholder=""  value={values.city} name='city' onChange={handleInputChange}
					 className="w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 dark:text-gray-900" />
				</div>
				<div className="col-span-full sm:col-span-2">
					<label htmlFor="state" className="text-sm">State / Province</label>
					<input id="state" type="text" placeholder=""  value={values.state} name='state' onChange={handleInputChange}
					className="w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 dark:text-gray-900" />
				</div>
				<div className="col-span-full sm:col-span-2">
					<label htmlFor="pincode" className="text-sm">Pincode </label>
					<input id="pincode" type="text" placeholder=""  value={values.pincode} name='pincode' onChange={handleInputChange}
					className="w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 dark:text-gray-900" />
				</div>
			</div>
		</fieldset>
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-violet-100">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div className="col-span-full">
					...
					<textarea id="bio" placeholder=""  value={values.bio} name='bio' onChange={handleInputChange}
					className="w-full rounded-md focus:ring focus:ri focus:ri border-gray-300 dark:text-gray-900"></textarea>
				</div>
				<div className="col-span-full">
					<label htmlFor="bio" className="text-sm">Photo</label>
					<img src={values.imageSrc} alt="" className="w-20 h-20 rounded-full bg-gray-500 bg-gray-300" />
					<div className="flex items-center space-x-2">
						
						<input type='file' accept='Images/*' onChange={showPreview}></input>
		...
		<div>
              <button
                type="submit"
                className="w-100 px-8 py-3 font-semibold rounded-md bg-violet-400 text-white"
              >
               Submit
              </button>
            </div>
