  ...
  return (
    <div>
      <div className="bg-white relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
                ...
                <div className="mt-16">
                    <h1 className	="font-bold text-center text-3xl text-gray-900">{employees?.firstName}</h1>
                    <p className="text-center text-sm text-gray-400 font-medium">{employees?.lastName}</p>
                    <p>
                        <span>
                    ...
                    <div className="my-5 px-6">
                        <a href="#" className="text-gray-200 block rounded-lg text-center font-medium leading-6 px-6 py-3 bg-gray-900 hover:bg-black hover:text-white">Connect with <span className="font-bold">{employees?.email}</span></a>
                    </div>
