...
import {  useDeleteJobTypeMutation, useUpdateJobTypeMutation } from "../API/jobTypeApi";
import ToastNotify from '../Helper/ToastNotify';


function JType({type}:any) {
    ...
    <th
       ...
       > {type.id}
        ...
        {isUpdating ? (
         ...
         defaultValue={type.jobTypeName}
         onChange={(e) =>setUpdateType(e.target.value)}
         />
         </td>
        ): (  <td className="px-4 py-3">{type.jobTypeName}</td>
         )} 
     ...
     <td className="px-4 py-3 flex items-center justify-end">
       <button onClick={()=>{
         ...
         className="flex w-full items-center py-2 px-4 bg-gray-400  text-gray-900"
       >
